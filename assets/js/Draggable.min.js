...
! function(e, t) {
    ...
    var h, u, r, i, f, g, x, m, y, t, v = "transform",
        b = v + "Origin",
    ...
    var xe, me, ye, ve, l, s, we, be, c, Te, d, De, Me, Ee, _e, Se, Xe, Pe, Le, Ye, k, O, n, Ce = 0,
        R = "transform",
        Ne = "transformOrigin",
        ke = Array.isArray,
        Ae = 180 / Math.PI,
    ...
    var Ke, F = (function _inheritsLoose(e, t) {
    ...
    function Draggable(h, p) {
        ...
        function Kh(e, t) {
            ...
            if (!u || q.isPressed || !e || !("mousedown" !== e.type && "pointerdown" !== e.type || t) && Re() - le < 30 && Me[q.pointerEvent.type]) I && e && u && Ba(e);
                ...
                if (R = !(!v || V == U || !1 === q.vars.allowNativeTouchScrolling || q.vars.allowContextMenu && e && (e.ctrlKey || 2 < e.which)) && (V ? "y" : "x"), (I = !R && !q.allowEventDefault) && (Ba(e), za(me, "touchforcechange", Ba)), e.changedTouches ? (e = x = e.changedTouches[0], m = e.identifier) : e.pointerId ? m = e.pointerId : x = m = null, Ce++, function _addToRenderQueue(e) {
                        ...
                        scrollTo: 1
                    }, !0), q.tween = q.lockedAxis = null, !p.zIndexBoost && (W || f || !1 === p.zIndexBoost) || (h.style.zIndex = Draggable.zIndex++), q.isPressed = !0, g = !(!p.onDrag && !q._listeners.drag), s = !(!p.onMove && !q._listeners.move), !1 !== p.cursor || p.activeCursor)
        ...
        var u, f, w, b, T, D, M, g, s, E, S, X, P, x, m, L, Y, t, C, N, k, y, v, A, O, R, B, z, F, c, I, d, H, n = (p.type || "x,y").toLowerCase(),
        ...
        return (t = Draggable.get(h)) && t.kill(), e.startDrag = function(e, t) {
            ...
            var n, o, r, i, a, l, s = "velocity" === e && Se ? e : $(e) && !W ? "element" : "start";
        ...
        isDragging: !1,
        isPressed: !1
    }), F.zIndex = 1e3, F.version = "3.12.2", Y() && xe.registerPlugin(F), e.Draggable = F, e.default = F;
